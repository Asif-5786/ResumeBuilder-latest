  ...
  const educationBody = (
    <div className={styles.detail}>
      ...
      <InputControl
        ...
        placeholder="Enter full name of the university"
        value={values.university}
        onChange={(event) =>
          setValues((prev) => ({ ...prev, university: event.target.value }))
        }
      />
      <InputControl
        label="Percentage/CGPA"
        placeholder="Enter percentage secured"
      ...
      <InputControl
        ...
        onChange={(event) =>
          setValues((prev) => ({ ...prev, passing: event.target.value }))
        }
      />
  ...
  useEffect(() => {
    ...
    setValues({
      ...
      title: activeInfo?.details
        ...
        : "",
      univerity: activeInfo?.details
        ? activeInfo.details[0]?.university || ""
        : "",
      percentage: activeInfo?.details
        ? activeInfo.details[0]?.percentage || ""
        : "",
      passing: activeInfo?.details
        ? activeInfo.details[0]?.passing || ""
        : "",
